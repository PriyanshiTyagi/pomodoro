...
time = canvas.create_text(101, 130, text="00:00", fill="white", font=(FONT_NAME, 30, "bold"))
canvas.grid(row=1, column=1)

timer_label = Label(text="TIMER", font=(FONT_NAME, 30, "bold"), bg=YELLOW, fg=GREEN)
timer_label.grid(row=0, column=1)

tick_label = Label(font=(FONT_NAME, 30, "bold"), bg=YELLOW, fg=GREEN)
tick_label.grid(row=3, column=1)

start_button = Button(text="START", highlightthickness=0, command=init_timer)
